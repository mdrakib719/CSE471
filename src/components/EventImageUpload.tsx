...
const EventImageUpload: React.FC<EventImageUploadProps> = ({
  ...
  const handleImageUpload = async (file: File) => {
    ...
    try {
      const imageUrl = await uploadImageToCloudinary(file, 'event-images');
        ...
        {eventImageUrl ? (
          <div className="space-y-4">
            <div className="relative group">
              <img
                src={getOptimizedImageUrl(eventImageUrl, 400, 300)}
                alt="Event Image"
            ...
            <Label htmlFor="replace-event-image" className="block">
              <Button
                variant="outline"
                className="w-full"
